...
sec1 = {(1,1), (2,1), (2,2), (3,1), (3,2), (1,2)}
sec2 = {(1,3), (1,4), (2,3), (2,4), (3,3), (3,4)}
sec3 = cells.difference(sec1.union(sec2))
...
combs_left = [()]
for k in range(1,3):
    for comb in combinations_with_replacement(sec3, k):
        to_check = True
        for c in comb:
...
states_computed = list(filter(lambda x: len(x[0][0]) == 2 and len(x[0][1]) == 2, states_computed))
states_computed = list(filter(lambda x: x[0][0][0] != x[0][0][1] and x[0][1][0] != x[0][1][1], states_computed))
