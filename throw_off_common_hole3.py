...
sec1 = {(0,0), (1,0), (0,1), (0,2), (0,3), (1,1), (1,2), (1,3)}
sec2 = {(0,4), (1,4), (2,4), (2,3), (3,0), (3,1), (3,2), (3,3), (3,4), (4,0), (4,1), (4,2), (4,3), (4,4)}
    ...
    for comb in combinations_with_replacement(cells, k):
        ...
        if max(cter.values()) == 1:
            ...
            if to_check:
                ...
                if max(cter.values()) == 1 and len(tuple(_comb)) == 2:
                    if tuple(_comb)[0] != tuple(_comb)[1]:
