...
# blocks.add(((1,3), (1,4)))
#
# sec1 = {(0,0), (1,0), (2,0), (3,0), (3,1)}
# sec2 = {(0,1), (0,2), (0,3), (0,4), (1,1), (1,4)}
# sec3 = {(2,1), (2,2), (2,3), (2,4), (1,2), (1,3)}
# sec4 = {(4,0),(4,1),(4,2),(4,3),(4,4),(3,2),(3,3),(3,4)}
...
# blocks.add(((3,0), (4,0)))
#
# sec1 = {(0,0), (1,0), (2,0), (3,0), (1,1), (2,1), (3,1), (2,2)}
# sec2 = {(0,1), (0,2), (1,2), (1,3), (2,3), (2,4), (3,4)}
# sec3 = {(0,3), (0,4), (1,4)}
# sec4 = {(4,0),(4,1),(4,2),(4,3),(4,4),(3,2),(3,3)}
...
sec1 = {(0,0), (1,0), (2,0), (3,0), (0,1), (1,1)}
sec2 = {(0,2), (0,3), (0,4), (1,2), (1,3), (1,4), (2,4), (3,4)}
sec3 = {(2,3), (3,3), (4,3), (4,4)}
sec4 = {(2,1), (2,2), (3,1), (3,2), (4,1), (4,2), (4,0)}
...
states_computed = list(filter(lambda x: len(x[0][0]) == 4 and len(x[0][1]) == 4, states_computed))
