...
states_computed = list(filter(lambda x: x[1] < 1000 and len(x[0][1]) == 3, states_computed))
states_computed = list(filter(lambda x: x[0][1][0] != x[0][1][1]
                        and x[0][1][1] != x[0][1][2], states_computed))
